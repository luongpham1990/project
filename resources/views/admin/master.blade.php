...
<head>
    ...
    <meta name="author" content="Tung ngo">
    <title>Admin - Tungnt</title>
    ...
    <!-- DataTables CSS -->
    <link href="/project/public/admin/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css"
          rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="/project/public/admin/bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
    ...
    <script src="/project/public/admin/js/ckeditor/ckeditor.js"></script>
    <script src="/project/public/admin/js/ckfinder/ckfinder.js"></script>
    <script src="/project/public/admin/js/func_ckfinder.js"></script>
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Admin Area - Tungnt</a>
        </div>
        <!-- /.navbar-header -->
...
<script src="/project/public/admin/bower_components/DataTables/media/js/jquery.dataTables.min.js"></script>
<script src="/project/public/admin/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>

<script src="/project/public/admin/js/myscript.js"></script>
